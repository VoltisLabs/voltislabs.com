...
const ThirdHero = () => {
  return (
    <section className="hero-section-container flex items-stretch w-full h-screen">
      
      {/* Left Section (Text + Button) */}
      <div className="py-6 px-4 md:px-8 bg-[#FFF1F1] w-1/2 h-full flex flex-col justify-between">
