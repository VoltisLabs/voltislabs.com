...
const SecondHero = () => {
  return (
    <section className="hero-section-container h-[35rem] flex items-center relative">
      <div className="left-section h-full md:w-[50%] w-full bg-[#AB28B280] p-7 pb-[4rem] flex md:items-end items-center">
        <div className="item-container">
          ...
          <div className="item-container flex items-center gap-2 p-1 border-solid border-white border-[1px] px-2 w-[14rem] h-[2rem] rounded-[9px]">
      ...
      <div className="right-section md:flex hidden md:w-[50%] bg-black h-full w-full">
        <div className="image-container h-full px-2 gap-2 w-[20rem] flex flex-col justify-between">
          ...
          <div className="image-wrapper h-[50%] w-full relative rounded-[8px] overflow-hidden">
            <Image
