...
//   return (
//     <div   className=" page-container pb-20 bg-black w-full">
     

//       <div style={{marginTop:700}}  className="content-container">
...
// >
//   <div className="flex flex-wrap gap-8 h-full md:w-full">
