...
const SecondHero = () => {
  return (
    <><section className="hero-section-container md:h-[42rem] h-[37rem] flex items-center relative">
      <div className="hidden md:flex left left-section h-full w-[50%] bg-[#AB28B280] md:p-7 p-2 flex items-end">
      ...
      <div className="mobile-picture-container relative bg-red-800 h-full md:hidden block w-full">
        ...
        {/* Centered Text */}
        <div className="absolute inset-0 flex items-center justify-center text-white text-[1.7rem] text-center z-10">
          A New Home for Your Fashion Finds.
        </div>

        <video
          src="/videos/Prelura.mp4"
          autoPlay
          muted
          loop
          playsInline
    ...
    <div className=" md:hidden left-section h-full md:w-[50%] w-full md:p-7 p-2 flex items-end">
