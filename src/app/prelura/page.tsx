      ...
      <div id="prelura-more" className="mx-auto mb-16 max-w-[45rem] px-[1.4rem] md:px-0">
        ...
        <section id="prelura-more" className="mb-8 text-white">
          ...
          <div className="text-section">
            ...
            <span className={paragrapghClassName}>
              The fashion industry produces 92 million tons of textile waste every year. Mass
              production has made clothing cheaper and more disposable, leading to overfilled
              closets and landfills packed with barely worn garments.
            </span>
          </div>
          <br />
          <div className="text-section">
            <span className={titleClassName}>Impulse Shopping & Unworn Clothing</span>
            <span className={paragrapghClassName}>
              The average person wears only 20% of their wardrobe regularly. The rest sits
              untouched, often forgotten until it’s time to declutter. But instead of tossing items
              away or hoarding them indefinitely, what if there was a better option?
            </span>
          </div>
          <br />
          <div className="text-section">
            <span className={titleClassName}>Challenges in the Resale Market</span>
            <span className={paragrapghClassName}>
        ...
        <section id="prelura-vision" className="">
          ...
          <div className="flex-section flex w-full items-start justify-between gap-3">
                ...
                <ul className="list-disc pl-5 text-white">
                  <li>
                    <span className={`${paragrapghClassName}`}>
                      ...
                      No confusing steps or unnecessary friction. Just list, sell, and ship.
                    </span>
                  </li>
                  <br />
                  <li>
                    <span className={`${paragrapghClassName}`}>
                      <span className="font-bold">Enjoyable - </span>A beautifully designed platform
                      that makes buying and selling feel exciting.
                    </span>
                  </li>
                  <br />
                  <li>
                  ...
                  <li>
                    <span className={`${paragrapghClassName}`}>
                      ...
                      Fighting fashion waste and supporting a more sustainable industry.
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="image-section h-[15rem] w-[50%] overflow-hidden rounded-[9px] bg-yellow-300 md:h-[22rem] md:w-[40%]">
              <Image
        ...
        <div className="title-text-section block md:hidden">
          <ul className="list-disc pl-5 text-white">
            ...
            <li>
              <span className={`${paragrapghClassName}`}>
                <span className="font-bold">Enjoyable - </span>A beautifully designed platform that
                makes buying and selling feel exciting.
              </span>
            </li>
            <br />
            <li>
        ...
        <section id="prelura-sellers" className="mb-8 text-white">
          ...
          <br />
          <br />
          <div className="image-container h-[15rem] overflow-hidden rounded-[8px] md:h-[30rem]">
            <Image
          ...
          <section id="prelura-help">
            ...
            <div className="text-container">
              ...
              <span className={paragrapghClassName}>
                We believe in circular fashion. Every purchase helps reduce fashion waste, giving
                clothes a second life instead of contributing to landfills
              </span>
            </div>
