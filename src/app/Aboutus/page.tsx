    ...
    <div className="px-5 md:px-8  pt-[.1rem] ">
      ...
      <section className="text-white my-8  mb-20 font-normal md:text-[1.1rem] text-[1rem]">
        ...
        <p className="font-normal">
          ...
          that are intuitive, scalable, and designed to make life easier. Our
          approach is rooted in innovation, but more importantly, in impact.
          Every product we create is built to solve a problem, to simplify
          complexity, and to open new doors for those who dare to dream big.
        </p>
        <p className="font-normal">Our Values</p>
        <ul className="list-disc pl-5">
          <li>
            Empowerment Through Technology – We believe that technology should
            give people more control over their lives, their work, and their
            creativity. Every solution we build is designed to help individuals
            and businesses do more with less friction.
          </li>
          <li>
            Innovation Without Limits – The digital landscape is constantly
            evolving, and so are we. We push boundaries, challenge the status
            quo, and embrace the unknown in pursuit of groundbreaking solutions.
          </li>
          <p className="font-normal">
            A People-First Approach – Technology is only as powerful as the
            people who use it. That’s why everything we create is built with a
            deep understanding of real-world needs, ensuring that our platforms
            are as intuitive as they are transformative.
          </p>

          <li>
            Sustainability & Inclusion – We don’t believe in building for a
            select few. Our goal is to create ecosystems that are accessible,
            diverse, and built to last.
          </li>
        </ul>
